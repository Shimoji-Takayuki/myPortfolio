...
<body>
    ...
    <p>スケジュール登録&nbsp;&nbsp;[<a href="/jspScheduleManager/schedule/MonthView?YEAR=<%= year%>&MONTH=<%= month %>>">カレンダーへ戻る</a>]</p>
    <div id="contents">
        <div id="left">
            <table class="sche">
                <tr>
        ...
        <div id="right">
            <form method="post" action="/jspScheduleManager/schedule/ExeInsertSchedule">
                ...
                <p><input type="submit" name="Register" value="登録する"> <input type="reset" value="入力し直す">
                <p>
            </form>
        </div>
    </div>
